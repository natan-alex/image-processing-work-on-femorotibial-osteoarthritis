...
class AiWindow(tk.Toplevel):
    ...
    def _handle_events(self):
        ...
        events.evaluate_rfc_button_clicked.subscribe(
            self._on_evaluate_rfc_button_clicked)
    ...
    def _on_train_normal_classifier_button_clicked(self):
        if self._model_datasets is None:
            ...
            return
        dataset_path=DatasetService.read_datasets()
        ...
        self._model=ModelService.create_rfc_model(dataset_path.folder_path)
    ...
    def _on_evaluate_rfc_button_clicked(self):
        """
        Clear screen to show elapsed time and redirect tensorflow output.
        After all show the metrics calculated by evaluation the test dataset
        """
